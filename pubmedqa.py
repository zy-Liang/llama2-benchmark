...
def main(
    ...
    ground_truth = json.loads(open("/home/zyliang/llama2-benchmark/datasets/test_ground_truth.json"))
    questions = json.loads(open("/home/zyliang/llama2-benchmark/datasets/test_set.json"))
